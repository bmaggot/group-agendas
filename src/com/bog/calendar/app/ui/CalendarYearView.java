...
public class CalendarYearView extends FrameLayout {
     ...
     */
    private boolean mShowDayHeader = false;

    /**
     * Flag whether to show the month name.
     */
    private boolean mShowMonthNameHeader = true;
    ...
    public interface OnDateChangeListener {
         ...
         */
        public void onSelectedDayChange(CalendarYearView view, int year, int month, int dayOfMonth);
    }
    ...
    public CalendarYearView(Context context, AttributeSet attrs, int defStyle) {
...
//        super.onConfigurationChanged(newConfig);
     ...
     */
    public void setDate(long date, boolean events) {
        ...
        mAdapter.registerDataSetObserver(new DataSetObserver() {
            ...
            public void onChanged() {
                if (mOnDateChangeListener != null) {
                    ...
                    mOnDateChangeListener.onSelectedDayChange(CalendarYearView.this,
...
//        mListView.setVelocityScale(mVelocityScale);
    ...
    private class WeeksAdapter extends BaseAdapter implements OnTouchListener {
        ...
        private void init() {
        	...
        	dtu = new DateTimeUtils(mContext);
...
//            mShownWeekCount = mTotalWeekCount;
        ...
        private void onDateTapped(Calendar day) {
            ...
            if(mEvents != null) showDialog(day);
        }
        
        private void showDialog(Calendar day){
        	AlertDialog.Builder builder;
        	AlertDialog alertDialog;
        	
        	final String strTime = dtu.formatDate(day.getTime());
        	
        	@SuppressWarnings("static-access")
			LayoutInflater inflater = (LayoutInflater) mContext.getSystemService(mContext.LAYOUT_INFLATER_SERVICE);
        	View layout = inflater.inflate(R.layout.year_dialog,(ViewGroup) findViewById(R.id.layout_root));
        	
        	ListView lv = (ListView) layout.findViewById(R.id.current_events_list);
        	EventListAdapter adapter = new EventListAdapter(mContext, getActualEvents(day));
        	lv.setAdapter(adapter);
        	
        	LinearLayout ll = (LinearLayout) layout.findViewById(R.id.add_event);
    ...
    private class WeekView extends View {
        ...
        private void drawWeekNumbers(Canvas canvas) {
        	//Log.e("isDraw", String.valueOf(isDrawEventsPoint));
            ...
            for (; i < nDays; i++) {
                ...
                if(isDrawEventsPoint){
                	if(!mDayNumbers[i].equals("")){
                		...
                		ArrayList<Event> events = getActualEvents(c);
                		if(events.size() > 1)	drawEventPoints(canvas, x+9, y, 2);
                	}
                }  
            }
        }
