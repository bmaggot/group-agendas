	...
	protected void onResume() {
		...
		if(NavbarActivity.showVerificationDialog){
			...
			if(!mAccount.getPhone1().contentEquals("") && !mAccount.getPhone1().contentEquals("null") && !mAccount.getPhone1_verified()){
				NavbarActivity.showDialogForPhoneVerification(SettingsActivity.this, mAccount.getPhone1_code()+mAccount.getPhone1(), "1", "true");
			}
			if(!mAccount.getPhone2().contentEquals("") && !mAccount.getPhone2().contentEquals("null") && !mAccount.getPhone2_verified()){
				NavbarActivity.showDialogForPhoneVerification(SettingsActivity.this, mAccount.getPhone2_code()+mAccount.getPhone2(), "2", "true");
			}
			if(!mAccount.getPhone3().contentEquals("") && !mAccount.getPhone3().contentEquals("null") && !mAccount.getPhone3_verified()){
				NavbarActivity.showDialogForPhoneVerification(SettingsActivity.this, mAccount.getPhone3_code()+mAccount.getPhone3(), "3", "true");
			}
