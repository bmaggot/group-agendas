...
public enum ViewState {
	MONTH, DAY, WEEK, YEAR, MINI_MONTH, AGENDA, TODAY, GO_TO_DATE, LIST_SEARCH, CHAT_THREADS, CALENDAR_SETTINGS;
	...
	public static ViewState getValueByString(String defaultCalendarView) {
		...
		if (defaultCalendarView.equalsIgnoreCase("CALENDAR_SETTINGS")|| defaultCalendarView.equalsIgnoreCase("CS")) return CALENDAR_SETTINGS;
		return null;
	}
}
